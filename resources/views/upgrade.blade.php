...
<head>
    ...
    <style>
        ...
        .feature-list li {
            font-size: .86rem; color: rgba(226,232,240,.8);
    ...
    <div class="guarantee-strip mb-4">
        <div class="row g-3 justify-content-center text-center">
            <div class="col-6 col-md-3">
                <div class="guarantee-item justify-content-center"><i class="bi bi-shield-check"></i><span>14 dias de garantia</span></div>
            </div>
            <div class="col-6 col-md-3">
                <div class="guarantee-item justify-content-center"><i class="bi bi-x-circle"></i><span>Sem contrato</span></div>
            </div>
            <div class="col-6 col-md-3">
                <div class="guarantee-item justify-content-center"><i class="bi bi-lock"></i><span>Pagamento seguro</span></div>
            </div>
            <div class="col-6 col-md-3">
                <div class="guarantee-item justify-content-center"><i class="bi bi-arrow-counterclockwise"></i><span>Cancele quando quiser</span></div>
            </div>
        </div>
    </div>
