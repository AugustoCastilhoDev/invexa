...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-soft mb-0">{{ $product->name }}</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('products.show', $product) }}" class="btn btn-outline-light">Ver Detalhes</a>
        ...
        <form method="POST" action="{{ route('products.update', $product) }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-3">
                            <label for="quantity" class="form-label text-soft">Quantidade <span class="text-danger">*</span></label>
