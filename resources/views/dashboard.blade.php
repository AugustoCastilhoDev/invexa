...
{{-- Fluxo de Caixa + Vencimentos próximos --}}
<div class="row g-3 mb-4">
            ...
            <div class="card-body p-0" style="max-height:320px;overflow-y:auto;">
                ...
                @else
                    <table class="table table-dark mb-0 align-middle table-dark-custom">
                        <thead><tr><th class="ps-3">Descrição</th><th>Vencimento</th><th>Valor</th><th>Tipo</th></tr></thead>
                        <tbody>
...
<div class="row g-3 mb-4">
    <div class="col-12">
        <div class="card dashboard-card card-dark-bg shadow-sm">
            <div class="card-header card-header-dark border-bottom d-flex justify-content-between align-items-center" style="border-color:rgba(248,113,113,.2) !important;">
    ...
    if (salesCtx) {
        ...
        new Chart(salesCtx, {
            ...
            data:{ labels, datasets:[
                {label:'Bruto',data:grossData,backgroundColor:g,borderColor:'transparent',borderWidth:0,borderRadius:6,borderSkipped:false,barPercentage:0.6,categoryPercentage:0.8},
            ...
            options:{
                ...
                plugins:{
                    ...
                    tooltip:{backgroundColor:'rgba(15,23,42,0.95)',borderColor:'rgba(148,163,184,0.2)',borderWidth:1,titleColor:'#e2e8f0',bodyColor:'#e2e8f0',padding:{x:14,y:10},cornerRadius:8,
                        callbacks:{
