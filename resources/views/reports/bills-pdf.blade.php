...
<div class="totals">
  Total: <strong>{{ $bills->count() }} registro(s)</strong> &nbsp;|&nbsp;
  Valor total: <strong>R$ {{ number_format($bills->sum('amount'), 2, ',', '.') }}</strong>
</div>

<table>
  <thead>
    <tr><th>Descri&ccedil;&atilde;o</th><th>Vencimento</th><th>Categoria</th><th class="text-end">Valor</th><th>Status</th></tr>
  </thead>
  <tbody>
    @foreach($bills as $b)
