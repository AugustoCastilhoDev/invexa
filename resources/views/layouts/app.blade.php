                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li>
                                <div class="dropdown-item-text">
                                    ...
                                    @if(Auth::check())
                                        <span class="badge mt-1 bg-opacity-25
                                              bg-{{ Auth::user()->role_badge }}
                                              text-{{ Auth::user()->role_badge }}"
                            ...
                            {{-- Link para gerenciar usuários (só admin) --}}
                            @if(Auth::check() && Auth::user()->isAdmin())
                                <li>
