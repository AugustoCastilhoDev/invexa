...
class SuperAdminController extends Controller
{
    ...
    {
        // Se já há uma sessão de impersonate ativa, restaura o superadmin antes
        ...
        // Garante que o usuário atual é de fato superadmin
        ...
        // Registra o superadmin na sessão ANTES de trocar o Auth
        session([
